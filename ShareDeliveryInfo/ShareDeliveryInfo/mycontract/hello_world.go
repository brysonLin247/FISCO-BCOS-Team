...
const HelloWorldABI = "[{\"constant\":false,\"inputs\":[{\"name\":\"_s\",\"type\":\"string\"}],\"name\":\"set\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"say\",\"outputs\":[{\"name\":\"\",\"type\":\"string\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"}]"

// HelloWorldBin is the compiled bytecode used for deploying new contracts.
var HelloWorldBin = ""
...
//
// Solidity: function set(string _s) returns()
func (_HelloWorld *HelloWorldTransactor) Set(opts *bind.TransactOpts, _s string) (*types.Transaction, error) {
	return _HelloWorld.contract.Transact(opts, "set", _s)
}

// Set is a paid mutator transaction binding the contract method 0x4ed3885e.
//
// Solidity: function set(string _s) returns()
func (_HelloWorld *HelloWorldSession) Set(_s string) (*types.Transaction, error) {
	return _HelloWorld.Contract.Set(&_HelloWorld.TransactOpts, _s)
}

// Set is a paid mutator transaction binding the contract method 0x4ed3885e.
//
// Solidity: function set(string _s) returns()
func (_HelloWorld *HelloWorldTransactorSession) Set(_s string) (*types.Transaction, error) {
	return _HelloWorld.Contract.Set(&_HelloWorld.TransactOpts, _s)
}
